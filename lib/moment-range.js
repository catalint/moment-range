 ...
 *
 * @param {!DateRange} other A date range to subtract from this one
 *
 * @return {!Array<DateRange>}
 */
DateRange.prototype._subtract = function(other) {
  var start = this.start;
  var end   = this.end;
 ...
 * Subtract one range from another.
 *
 * @param {!Array<DateRange>} other A date range to subtract from this one
 *
 * @return {!Array<DateRange>}
 */
DateRange.prototype._subtractArray = function(other) {
  other = other.slice()
  let result = this.subtract(other.pop())
  if (other.length) {
    let flatResult = []
    result.forEach(function(open) {
      flatResult = flatResult.concat(open.subtract(other))
    });
    result = flatResult
  }
  return result
 ...
 * Subtract one range from another.
 *
 * @param {!DateRange|!Array<DateRange>} other A date range or array of date ranges to subtract from this one
 *
 * @return {!Array<DateRange>}
 */
DateRange.prototype.subtract = function(other) {
  if (Array.isArray(other)) {
    return this._subtractArray(other)
  } else {
